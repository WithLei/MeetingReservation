...
import com.android.renly.meetingreservation.utils.face.FaceRegisterInfo;
...
public class FaceServer {
            ...
            if (code == ErrorInfo.MOK && faceInfoList.size() > 0) {
                ...
                try {
                    ...
                    if (code == ErrorInfo.MOK) {
                        ...
                        LogUtils.printLog("faceFeature.getFeatureData().length" + new String(faceFeature.getFeatureData()));
                        return true;
                    }
                } catch (IOException e) {
                    e.printStackTrace();
    ...
    public boolean doMyRegister(byte[] nv21, String userName) {
        FaceFeature faceFeature = new FaceFeature();
    ...
    public CompareResult getTopOfFaceLib(FaceFeature faceFeature) {
        ...
        isProcessing = true;
        LogUtils.printLog("faceRegisterInfoList.size()=" + faceRegisterInfoList.size());
        for (int i = 0; i < faceRegisterInfoList.size(); i++) {
            ...
            LogUtils.printLog("faceSimilar.getScore()=" + faceSimilar.getScore()
