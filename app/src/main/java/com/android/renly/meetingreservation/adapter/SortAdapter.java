...
public class SortAdapter extends BaseAdapter implements SectionIndexer {
	...
	public View getView(final int position, View view, ViewGroup arg2) {
		...
		if (isNeedCheck) {
			...
			if (model.isChecked())
				viewHolder.checked.setImageResource(R.drawable.ic_round_checked);
			else
				viewHolder.checked.setImageResource(R.drawable.ic_round_unchecked);
		} else {
